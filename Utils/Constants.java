...
public class Constants {
    ...
    public static String COURSE_ADDED_SUCCESSFULLY = "Course has been added";
    public static String COURSE_NOT_FOUND = "Course not found";
    public static String COURSE_UPDATED_SUCCESSFULLY = "Course has been updated";
    public static String COURSE_DELETED_SUCCESSFULLY = "Course has been deleted";
